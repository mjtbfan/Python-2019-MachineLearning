...
"python %file%.py" to run given the above libraries are installed. Additionally, the data files stored
in /data should not be moved without properly updating the code references to these files.